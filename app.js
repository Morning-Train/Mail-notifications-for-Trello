...
var getAllCardsForEachUser = function(notifiers) {
    ...
    notifiers.forEach(function(notify) {
        getTogglProjectSummary(notify, function(togglProject) {
            ...
            notify.lists.forEach(function(list, i) {
...
var setupEmailTemplate = function(userArray, res) {
    ...
    userArray.forEach(function(user) {
        ...
        if (user.lists.length > 0) {
            ...
            emailContent += "<th align='center' style='background-color: #dc931a; width: 100%; margin:0 auto; border-top-left-radius: 10px; border-top-right-radius: 10px; border: 25px solid #dc931a;'><h1 style='  margin: 0 !important; color:#fff; font-size: 12px; text-transform: uppercase; padding-bottom: 7px; font-size: 20px;'>" + getBoardName(user.boardId) + "</h1><h2 style='   margin: 0 !important; padding-top: 7px;  color: #fff;font-size: 10px; text-transform: uppercase;'>Ændringer udført af Morning Train Technologies<strong></strong></h2></th>";
            // emailContent += "<tr>";
            ...
            // emailContent += "</tr>";
            emailContent += "<tr>";
            emailContent += "<td align='center' style='padding-top: 5px; padding-bottom: 5px; padding-left: 5%; padding-right: 5%;'><br>Nedenstående er en tabel over hvilke ændringer der er blevet foretaget af Morning Train. Hvis der er tvivl omkring disse ændringer, er du velkommen til at kontakte os på: 7199 5530 eller mail@morningtrain.dk</td>";
            emailContent += "</tr>";
            ...
            if (user.overallTime != null) {
                ...
                var hours = x | 0;
                emailContent += "<tr>";
                emailContent += "<td align='center' style='padding-top: 5px; padding-bottom: 5px; padding-left: 5%; padding-right: 5%;'>Tid brugt på jeres projekt: <b>" + hours + " timer og " + minutes + " minutter.</b></td>";
                emailContent += "</tr>";
            }
            ...
            emailContent += "<br></td></tr>";
            emailContent += "</tbody>";
            emailContent += "<tr align='center'><td style=' background-color: #dc931a; color: #fff; padding-bottom: 20px;padding-top: 20px;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;   font-size: 11px;'><strong>Morning Train Technologies ApS © 2010 - 2015 | Gammelsø 4, 5000 Odense C, Danmark <br> Tlf: 7199 5530 | Mail: <a href='mailto:mail@morningtrain.dk' style='color: white'>mail@morningtrain.dk</a> | CVR: 33362749</strong></td></tr>";
            emailContent += "</table>";
            emailContent += "<br><br>";
            emailContent += "<center><strong>Med venlig hilsen</strong></center><br>";
            emailContent += "<center><img src='https://morningtrain.dk/wp-content/uploads/2015/11/logomobile.png' alt='Morning Train Technologies'></center>";
            emailContent += "</div>";
